...
- Keep the next issue validation-only and focused on the documented backend local-complete criteria before any production, remote Supabase, App/API/Dashboard, Apple Shortcut, alias implementation, wrapper, package script, reporting, AI, Projection, or legacy work.
