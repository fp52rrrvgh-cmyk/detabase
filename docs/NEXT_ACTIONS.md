...
- Keep the next issue scoped to the smallest UX/usability improvement.
...
- Define the next read-only finance review usability boundary after grouped-date and scanability validation.
